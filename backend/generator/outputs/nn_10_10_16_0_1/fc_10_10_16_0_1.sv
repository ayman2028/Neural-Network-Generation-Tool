...
module fc_10_10_16_0_1(clk, reset, input_valid, input_ready, input_data, output_valid, output_ready, output_data);
	parameter M = 10;
	parameter N = 10;
	parameter T = 16;
	parameter P = 1;
...
module rom_gem_p1(clk, addr, z);
	...
	generate
		...
		if (I == 0) begin
			...
			assign values[64] = 16'd64;
			assign values[65] = 16'd65;
			assign values[66] = 16'd66;
			assign values[67] = 16'd67;
			assign values[68] = 16'd68;
			assign values[69] = 16'd69;
			assign values[70] = 16'd70;
			assign values[71] = 16'd71;
			assign values[72] = 16'd72;
			assign values[73] = 16'd73;
			assign values[74] = 16'd74;
			assign values[75] = 16'd75;
			assign values[76] = 16'd76;
			assign values[77] = 16'd77;
			assign values[78] = 16'd78;
			assign values[79] = 16'd79;
			assign values[80] = 16'd80;
			assign values[81] = 16'd81;
			assign values[82] = 16'd82;
			assign values[83] = 16'd83;
			assign values[84] = 16'd84;
			assign values[85] = 16'd85;
			assign values[86] = 16'd86;
			assign values[87] = 16'd87;
			assign values[88] = 16'd88;
			assign values[89] = 16'd89;
			assign values[90] = 16'd90;
			assign values[91] = 16'd91;
			assign values[92] = 16'd92;
			assign values[93] = 16'd93;
			assign values[94] = 16'd94;
			assign values[95] = 16'd95;
			assign values[96] = 16'd96;
			assign values[97] = 16'd97;
			assign values[98] = 16'd98;
			assign values[99] = 16'd99;
		end
	endgenerate
